                        ...
                        <tbody>
                            <?php foreach($ruangan as $r => $ruangan) : ?>
                                <tr>
                                    ...
                                    <td>Rp <?php echo number_format($ruangan['harga'],0,',','.') ?></td>
                                    <td><?= $ruangan['status']; ?></td>
                                    <td>
                                    <a href="/ruangan/edit/<?= $ruangan['id_ruangan']; ?>" class="btn btn-sm btn-success me-1"><i class="fa fa-edit"></i></a>                                    

                                        <form action="ruangan/<?= $ruangan['id_ruangan']; ?>" method="post" class="d-inline">
                                            <?= csrf_field(); ?>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="col-md-10">
            ...
            <input type="text" class="form-control" name="kode_ruangan" autofocus required>
        </div>
