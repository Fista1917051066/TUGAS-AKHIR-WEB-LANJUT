...
<div class="row">
    <div class="col-12">
        <div class="card m-b-30">
            <div class="card-body">
                <h1>Data Dokter</h1>
                <a href="/dokter/create" class="btn btn-sm btn-success" data-target="#addModal" data-toggle="modal"> <i class="fa fa-plus"></i> Tambah</a>
                        ...
                        <tbody>
                            <?php foreach($dokter as $i => $dokter) : ?>
                                <tr>
                                    ...
                                    <td>
                                    <a href="/dokter/edit/<?= $dokter['id_dokter']; ?>" class="btn btn-sm btn-success me-1"><i class="fa fa-edit"></i></a>                                    

                                        <form action="dokter/<?= $dokter['id_dokter']; ?>" method="post" class="d-inline">
                                            <?= csrf_field(); ?>
                                            <input type="hidden" name="_method" value="delete">
                                            <button type="submit" class="btn btn-danger btn-sm btn-delete" onclick="return confirm('Apakah Anda Yakin Menghapus Data?');"><i class="fa fa-trash"></i></button>
                                        </form>
                                    </td>
                                </tr>
                            <?php endforeach ;?>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="col-md-10">
            ...
            <input type="text" class="form-control" name="spesialis" autofocus required>
        </div>

        <div class="col-md-10">
            <label>No HP</label>
            <input type="text" class="form-control" name="nohp_dokter" autofocus required>
        </div>
        ...
        <div class="col-md-10">
            ...
            <textarea name="jadwal_praktek" id="jadwal_praktek" cols="5" rows="3" class="form-control" required></textarea>
        </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <?php
            ...
            // $query_edit = mysqli_query($koneksi, "SELECT * FROM mhs WHERE id_dokter='$id_dokter'");
...
<script>
    $(document).on("click", "#tombolUbah", function() {
        ...
        $(".modal-body #id_dokter").val(id);
        $(".modal-body #kode_dokter").val(kode);
        $(".modal-body #nama_dokter").val(nama);
        $(".modal-body #spesialis").val(spes);
        $(".modal-body #nohp_dokter").val(nohp);
        $(".modal-body #alamat_dokter").val(alamat);
        $(".modal-body #jadwal_praktek").val(jadwal);
    });
</script>
