...
<script>
    ...
    function ambilpasien(kode_pasien, nama_pasien, nohp_pasien, alamat_pasien)
    {
        $('#kode_pasien'). val(kode_pasien);
        $('#nama_pasien'). val(nama_pasien);
        $('#nohp_pasien'). val(nohp_pasien);
        $('#alamat_pasien'). val(alamat_pasien);
        $('#addbtnpasien'). modal('hide');
    }
    function ambilruangan(kode_ruangan, nama_ruangan, harga)
    {
        $('#kode_ruangan'). val(kode_ruangan);
...
<div class= "form-group row">
    ...
    <div class="col-md-3">
            <input type="text" class="form-control" name="kode_rawatinap" id="kode_rawatinap"
...
<div class="form-group row">
    <div class="input-group mt-2 col-13">
        <input type="text" id="kode_dokter" name="kode_dokter" class="form-control" placeholder="Pilih Dokter">
...
<div class="form-group row">
    <div class="input-group mt-1 col-13">
        <input type="text" id="kode_pasien" name="kode_pasien" class="form-control" placeholder="Pilih Pasien" aria-label="Search for...">
            <span class="input-group-append">
            <input type="text" id="nama_pasien" name="nama_pasien" class="form-control" placeholder="Nama Pasien" aria-label="Search for...">
            </span>
            <span class="input-group-append">
            <input type="hidden" id="nohp_pasien" name="nohp_pasien" class="form-control" placeholder="No HP Pasien" aria-label="Search for...">
            </span>
            <input type="hidden" id="alamat_pasien" name="alamat_pasien" class="form-control" placeholder="Alamat Pasien" aria-label="Search for...">
            </span>
            <span class="input-group-append">
...
<div class="form-group row">
    <div class="input-group mt-1 col-13">
        <input type="text" id="kode_ruangan" name="kode_ruangan" class="form-control" placeholder="Pilih Ruangan" aria-label="Search for...">
            <span class="input-group-append">
            <input type="text" id="nama_ruangan" name="nama_ruangan" class="form-control" placeholder="Pilih Ruangan" aria-label="Search for...">
            </span>
            <input type="hidden" id="harga" name="harga" class="form-control" placeholder="Harga" aria-label="Search for...">
            </span>
...
<div class="form-group row">
    <label for="example-date-input" class="col-sm-4 col-form-label">Tanggal Masuk</label>
    <div class="col-sm-6">
        <input class="form-control" name="tglmasuk" type="date" id="example-date-input">
    </div>
</div>

<div class="form-group row">
    <label for="example-date-input" class="col-sm-4 col-form-label">Lama Rawat Inap</label>
    <div class="col-sm-6">
        <input class="form-control" name="lamarawat" type="text" placeholder="Masukkan lama rawat inap (hari)" id="example-date-input">
    </div>
</div>

<div class="form-group row">
    <label for="example-date-input" name="catatanmedis"class="col-sm-4 col-form-label">Rekam Medis</label>
    <div class="col-sm-8">
        ...
        <div class="modal-content">
            ...
            <table class="table table-sm table-stripped" id=datadokter>
                ...
                <tr>
                    ...
                    <td>
                        <button class="btn btn-primary btn-xs" type="button" 
                        onClick="return ambilpasien('<?php echo $row["kode_pasien"]?>','<?php echo  $row["nama_pasien"]?>','<?php echo  $row["nohp_pasien"]?>', '<?php echo  $row["alamat_pasien"]?>')">
                        <span class='glyphicon glyphicon-check'></span>Pilih</button>
                    </td>
                </tr>
<?php endforeach ;?>
        ...
        <div class="modal-content">
            ...
            <table class="table table-sm table-stripped" id=datadokter>
                ...
                <tr>
                    ...
                    <td>
                        <button class="btn btn-primary btn-xs" type="button" 
                        onClick="return ambilruangan('<?php echo $row["kode_ruangan"]?>','<?php echo  $row["nama_ruangan"]?>', '<?php echo  $row["harga"]?>')">
                        <span class='glyphicon glyphicon-check'></span>Pilih</button>
                    </td>
                </tr>
<?php endforeach ;?>
